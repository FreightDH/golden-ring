(() => {
  ...
  const slidesInfo = [
    ...
    },
    {
      ...
      date: '1152 г.',
      sights:
        'Краеведческий музей, «Ботик Петра I», Спасо-Преображенский собор, музей утюга, Синий камень, Плещеево озеро',
    },
    {
      image: 'rostov',
      city: 'Ростов Великий',
  ...
  function createSlide(info) {
    ...
    const slideImage = slides_createElement(
      'div',
      'slide__image',
  ...
  function loopFix(_temp) {
    ...
    const slidesPerView =
      params.slidesPerView === 'auto' ? swiper.slidesPerViewDynamic() : Math.ceil(parseFloat(params.slidesPerView, 10));
    ...
    function update() {
        ...
        if (el.length > 1)
          ...
          if (params.dynamicBullets) {
            ...
            for (let i = firstIndex; i <= lastIndex; i += 1)
              if (bullets[i]) bullets[i].classList.add(...`${params.bulletActiveClass}-main`.split(' '));
      ...
      el.forEach((subEl, subElIndex) => {
        ...
        if (params.type === 'progressbar') {
          ...
          subEl
            .querySelectorAll(classes_to_selector_classesToSelector(params.progressbarFillClass))
            .forEach((progressEl) => {
      ...
      el.forEach((subEl) => {
        ...
        if (params.type === 'bullets')
          swiper.pagination.bullets.push(
            ...subEl.querySelectorAll(classes_to_selector_classesToSelector(params.bulletClass)),
          );
      });
